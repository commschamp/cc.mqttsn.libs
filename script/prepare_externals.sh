...
function build_mqttsn() {
    ...
    cmake -S ${CC_MQTTSN_SRC_DIR} -B ${CC_MQTTSN_BUILD_DIR} -DCMAKE_INSTALL_PREFIX=${CC_MQTTSN_INSTALL_DIR} -DCMAKE_BUILD_TYPE=${COMMON_BUILD_TYPE} -DCMAKE_CXX_STANDARD=${COMMON_CXX_STANDARD}
...
function build_mqtt311() {
    ...
    cmake -S ${CC_MQTT311_SRC_DIR} -B ${CC_MQTT311_BUILD_DIR} -DCMAKE_INSTALL_PREFIX=${CC_MQTT311_INSTALL_DIR} -DCMAKE_BUILD_TYPE=${COMMON_BUILD_TYPE} -DCMAKE_CXX_STANDARD=${COMMON_CXX_STANDARD}
