    ...
    m_funcs(funcs)
{
    ...
    test_assert(m_funcs.m_get_connection_status != nullptr);
...
void UnitTestCommonBase::unitTestDoConnect(CC_MqttsnClient* client, const CC_MqttsnConnectConfig* config, const CC_MqttsnWillConfig* willConfig)
{
    ...
    test_assert(apiGetConnectionState(client)  == CC_MqttsnConnectionStatus_Connected);
}
...
CC_MqttsnConnectionStatus UnitTestCommonBase::apiGetConnectionState(CC_MqttsnClient* client)
{
    return m_funcs.m_get_connection_status(client);
}
